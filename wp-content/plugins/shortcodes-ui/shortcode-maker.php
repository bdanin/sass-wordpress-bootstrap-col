...
JS;
		...
		public function manage_sc_columns($column_name, $id) {
			...
			case 'image':
				...
				if (false != $image && !empty($image)){
					...
					echo '<img src="/wp-content/plugins/shortcodes-ui/images/sc.png" width="80px" height="80px"/>';
				}
				break;
			case 'sc_tag':
				//get tag
		...
		public function register_cpt_ba_sh() {
			...
			$args = array( 
				...
				'show_ui' =>  true,
				'show_in_menu' => true,
				'menu_icon' => 'https://insidelaw.gsu.edu/wp-content/plugins/shortcodes-ui/images/sc_icon.png',
